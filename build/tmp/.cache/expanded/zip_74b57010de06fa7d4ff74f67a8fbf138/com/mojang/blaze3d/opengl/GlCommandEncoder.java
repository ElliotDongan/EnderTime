...
public class GlCommandEncoder implements CommandEncoder {
        ...
        if (this.inRenderPass) {
            ...
            if (glbuffer.closed) {
                ...
                if (i > p_405833_.length()) {
                    ...
                    this.device.directStateAccess().bufferSubData(glbuffer.handle, p_405833_.offset(), p_397249_);
                }
            }
        }
    }
    ...
    public void writeToTexture(
        ...
        if (this.inRenderPass) {
            ...
            if (p_396347_ * p_408032_ > p_397466_.remaining()) {
                throw new IllegalArgumentException(
                    "Copy would overrun the source buffer (remaining length of " + p_397466_.remaining() + ", but copy is " + p_396347_ + "x" + p_408032_ + ")"
                );
                ...
                GlStateManager._texSubImage2D(i, p_394994_, p_394993_, p_393355_, p_396347_, p_408032_, GlConst.toGl(p_392785_), 5121, p_397466_);
            }
        } else {
    ...
    protected void executeDraw(GlRenderPass p_391991_, int p_395477_, int p_392599_, int p_409900_, @Nullable VertexFormat.IndexType p_391193_, int p_408977_) {
        if (this.trySetup(p_391991_, Collections.emptyList())) {
            if (GlRenderPass.VALIDATION) {
                ...
                if ((p_391991_.vertexBuffers[0].usage() & 32) == 0) {
