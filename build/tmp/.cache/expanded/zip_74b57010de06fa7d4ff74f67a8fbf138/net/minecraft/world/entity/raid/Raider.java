...
public abstract class Raider extends PatrollingMonster {
    ...
    static final Predicate<ItemEntity> ALLOWED_ITEMS = p_405569_ -> !p_405569_.hasPickUpDelay()
        && p_405569_.isAlive()
        && ItemStack.matches(p_405569_.getItem(), Raid.getOminousBannerInstance(p_405569_.registryAccess().lookupOrThrow(Registries.BANNER_PATTERN)));
    ...
    protected void readAdditionalSaveData(ValueInput p_409953_) {
        ...
        if (this.level() instanceof ServerLevel serverlevel) {
            p_409953_.getInt("RaidId").ifPresent(p_405568_ -> {
                this.raid = serverlevel.getRaids().get(p_405568_);
                if (this.raid != null) {
