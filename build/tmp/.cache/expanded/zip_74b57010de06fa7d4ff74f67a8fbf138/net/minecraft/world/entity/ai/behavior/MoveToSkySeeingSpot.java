...
public class MoveToSkySeeingSpot {
    public static OneShot<LivingEntity> create(float p_259860_) {
        return BehaviorBuilder.create(
            p_258543_ -> p_258543_.group(p_258543_.absent(MemoryModuleType.WALK_TARGET)).apply(p_258543_, p_258545_ -> (p_405376_, p_405377_, p_405378_) -> {
                if (p_405376_.canSeeSky(p_405377_.blockPosition())) {
                    return false;
                } else {
                    Optional<Vec3> optional = Optional.ofNullable(getOutdoorPosition(p_405376_, p_405377_));
