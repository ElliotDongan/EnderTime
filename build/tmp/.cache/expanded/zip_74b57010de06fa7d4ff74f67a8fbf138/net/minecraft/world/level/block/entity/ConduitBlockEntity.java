...
public class ConduitBlockEntity extends BlockEntity {
    ...
    private static void updateAndAttackTarget(ServerLevel p_409086_, BlockPos p_408285_, BlockState p_408764_, ConduitBlockEntity p_406103_, boolean p_405900_) {
        ...
        LivingEntity livingentity = EntityReference.get(entityreference, p_409086_, LivingEntity.class);
    ...
    private static EntityReference<LivingEntity> updateDestroyTarget(
        ...
        if (!p_406113_) {
            ...
            LivingEntity livingentity = EntityReference.get(p_408219_, p_406553_, LivingEntity.class);
    ...
    private static EntityReference<LivingEntity> selectNewTarget(ServerLevel p_406173_, BlockPos p_409120_) {
        List<LivingEntity> list = p_406173_.getEntitiesOfClass(LivingEntity.class, getDestroyRangeAABB(p_409120_), p_405706_ -> p_405706_ instanceof Enemy && p_405706_.isInWaterOrRain());
        return list.isEmpty() ? null : new EntityReference<>(Util.getRandom(list, p_406173_.random));
    }
