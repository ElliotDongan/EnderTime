                            ...
                            if (optional.isEmpty()) {
                                ...
                                p_258916_.<List<LivingEntity>>get(p_258903_)
                                    ...
                                    .ifPresent(p_390624_ -> {
                                        ...
                                        p_258905_.erase();
                                        p_258901_.erase();
                                        if (p_390624_.getBrain().getMemory(MemoryModuleType.JOB_SITE).isEmpty()) {
                                            BehaviorUtils.setWalkAndLookTargetMemories(p_390624_, blockpos, p_259768_, 1);
                                            p_390624_.getBrain().setMemory(MemoryModuleType.POTENTIAL_JOB_SITE, GlobalPos.of(p_258912_.dimension(), blockpos));
