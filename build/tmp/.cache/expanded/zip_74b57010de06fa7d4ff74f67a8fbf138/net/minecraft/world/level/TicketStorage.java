...
public class TicketStorage extends SavedData {
    ...
    public void purgeStaleTickets(ChunkMap p_407417_) {
        this.removeTicketIf((p_405675_, p_405676_) -> {
            ChunkHolder chunkholder = p_407417_.getUpdatingChunkIfPresent(p_405675_);
    ...
    public void removeTicketIf(BiPredicate<Long, Ticket> p_408274_, @Nullable Long2ObjectOpenHashMap<List<Ticket>> p_396309_) {
