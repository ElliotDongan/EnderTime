...
public class MangroveLeavesBlock extends TintedParticleLeavesBlock implements BonemealableBlock {
    public static final MapCodec<MangroveLeavesBlock> CODEC = RecordCodecBuilder.mapCodec(
        p_391789_ -> p_391789_.group(ExtraCodecs.floatRange(0.0F, 1.0F).fieldOf("leaf_particle_chance").forGetter(p_396597_ -> p_396597_.leafParticleChance), propertiesCodec())
            .apply(p_391789_, MangroveLeavesBlock::new)
    );
