...
public class Bogged extends AbstractSkeleton implements Shearable {
    ...
    private void spawnShearedMushrooms(ServerLevel p_362178_, ItemStack p_364629_) {
        this.dropFromShearingLootTable(p_362178_, BuiltInLootTables.BOGGED_SHEAR, p_364629_, (p_405498_, p_405499_) -> this.spawnAtLocation(p_405498_, p_405499_, this.getBbHeight()));
    }
