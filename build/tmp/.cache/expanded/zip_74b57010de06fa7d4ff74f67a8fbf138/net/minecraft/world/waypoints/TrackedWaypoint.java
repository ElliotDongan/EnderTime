...
public abstract class TrackedWaypoint implements Waypoint {
    ...
    public abstract double yawAngleToCamera(Level p_410364_, TrackedWaypoint.Camera p_406013_);

    public abstract TrackedWaypoint.PitchDirection pitchDirectionToCamera(Level p_410713_, TrackedWaypoint.Projector p_407938_);
    ...
    static class Vec3iWaypoint extends TrackedWaypoint {
        ...
        private Vec3 position(Level p_409788_) {
            return this.identifier
                .left()
