...
public class SandBlock extends ColoredFallingBlock {
    public static final MapCodec<SandBlock> CODEC = RecordCodecBuilder.mapCodec(
        p_391601_ -> p_391601_.group(ColorRGBA.CODEC.fieldOf("falling_dust_color").forGetter(p_395369_ -> p_395369_.dustColor), propertiesCodec())
            .apply(p_391601_, SandBlock::new)
    );
