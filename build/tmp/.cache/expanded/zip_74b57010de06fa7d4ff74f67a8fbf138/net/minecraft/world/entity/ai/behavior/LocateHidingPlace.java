                ...
                .apply(
                    ...
                    (p_258484_, p_258485_, p_258486_, p_258487_, p_258488_, p_258489_, p_258490_) -> (p_405371_, p_405372_, p_405373_) -> {
                        p_405371_.getPoiManager()
                            ...
                            .filter(p_405359_ -> p_405359_.closerToCenterThan(p_405372_.position(), p_259982_))
                            .or(
                                () -> p_405371_.getPoiManager()
                                    .getRandom(
                            ...
                            .ifPresent(p_405356_ -> {
                                ...
                                if (!p_405356_.closerToCenterThan(p_405372_.position(), p_259982_)) {
                                    p_258484_.set(new WalkTarget(p_405356_, p_259881_, p_259982_));
                                }
                            });
                        return true;
                    }
