...
public class TintedParticleLeavesBlock extends LeavesBlock {
    public static final MapCodec<TintedParticleLeavesBlock> CODEC = RecordCodecBuilder.mapCodec(
        p_393766_ -> p_393766_.group(ExtraCodecs.floatRange(0.0F, 1.0F).fieldOf("leaf_particle_chance").forGetter(p_393870_ -> p_393870_.leafParticleChance), propertiesCodec())
            .apply(p_393766_, TintedParticleLeavesBlock::new)
    );
