...
public class ExtraCodecs {
    ...
    public static final Codec<Integer> NON_NEGATIVE_INT = intRangeWithMessage(0, Integer.MAX_VALUE, p_395838_ -> "Value must be non-negative: " + p_395838_);
    public static final Codec<Integer> POSITIVE_INT = intRangeWithMessage(1, Integer.MAX_VALUE, p_406791_ -> "Value must be positive: " + p_406791_);
    public static final Codec<Float> NON_NEGATIVE_FLOAT = floatRangeMinInclusiveWithMessage(0.0F, Float.MAX_VALUE, p_392346_ -> "Value must be non-negative: " + p_392346_);
    public static final Codec<Float> POSITIVE_FLOAT = floatRangeMinExclusiveWithMessage(0.0F, Float.MAX_VALUE, p_409778_ -> "Value must be positive: " + p_409778_);
