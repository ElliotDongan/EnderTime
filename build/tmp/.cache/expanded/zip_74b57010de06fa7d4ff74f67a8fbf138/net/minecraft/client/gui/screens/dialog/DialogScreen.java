...
public abstract class DialogScreen<T extends Dialog> extends Screen {
    ...
    public static class WarningScreen extends ConfirmScreen {
        ...
        public static Screen create(Minecraft p_408421_, Screen p_406751_) {
            return new DialogScreen.WarningScreen(p_408421_, new MutableObject<>(p_406751_));
        }

        private WarningScreen(Minecraft p_406191_, MutableObject<Screen> p_410255_) {
            super(
                p_408993_ -> {
                    if (p_408993_) {
                        PauseScreen.disconnectFromWorld(p_406191_, DialogScreen.DISCONNECT);
                    } else {
