    ...
    class ItemStatisticsList extends ObjectSelectionList<StatsScreen.ItemStatisticsList.ItemRow> {
        ...
        protected void renderHeader(GuiGraphics p_282214_, int p_97050_, int p_97051_) {
            ...
            for (int i = 0; i < this.iconSprites.length; i++) {
                ...
                p_282214_.blitSprite(RenderPipelines.GUI_TEXTURED, resourcelocation, p_97050_ + this.getColumnX(i) - 18, p_97051_ + 1, 18, 18);
            }
            ...
            if (this.sortColumn != null) {
                ...
                p_282214_.blitSprite(RenderPipelines.GUI_TEXTURED, resourcelocation1, p_97050_ + j, p_97051_ + 1, 18, 18);
            }

            for (int k = 0; k < this.iconSprites.length; k++) {
                int l = this.headerPressed == k ? 1 : 0;
                p_282214_.blitSprite(RenderPipelines.GUI_TEXTURED, this.iconSprites[k], p_97050_ + this.getColumnX(k) - 18 + l, p_97051_ + 1 + l, 18, 18);
            }
        }
        ...
        protected void renderDecorations(GuiGraphics p_283203_, int p_97046_, int p_97047_) {
            if (p_97047_ >= this.getY() && p_97047_ <= this.getBottom()) {
                ...
                if (statsscreen$itemstatisticslist$itemrow != null) {
                    ...
                    p_283203_.setTooltipForNextFrame(StatsScreen.this.font, item.getName(), p_97046_, p_97047_, item.components().get(DataComponents.TOOLTIP_STYLE));
                } else {
                    ...
                    if (component != null) {
                        p_283203_.setTooltipForNextFrame(StatsScreen.this.font, component, p_97046_, p_97047_);
                    }
                }
            }
        }
        ...
        class ItemRow extends ObjectSelectionList.Entry<StatsScreen.ItemStatisticsList.ItemRow> {
            ...
            public void render(
                ...
                p_283614_.blitSprite(RenderPipelines.GUI_TEXTURED, StatsScreen.SLOT_SPRITE, p_97084_, p_97083_, 18, 18);
