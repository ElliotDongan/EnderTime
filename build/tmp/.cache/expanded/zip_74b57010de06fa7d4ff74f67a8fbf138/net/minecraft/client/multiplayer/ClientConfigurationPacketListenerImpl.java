...
public class ClientConfigurationPacketListenerImpl extends ClientCommonPacketListenerImpl implements ClientConfigurationPacketListener, TickablePacketListener {
    ...
    protected DialogConnectionAccess createDialogAccess() {
        return new DialogConnectionAccess() {
            @Override
            public void disconnect(Component p_406661_) {
                ClientConfigurationPacketListenerImpl.this.connection.disconnect(p_406661_);
            }
            ...
            @Override
            public void openDialog(Holder<Dialog> p_408953_, @Nullable Screen p_409779_) {
                ClientConfigurationPacketListenerImpl.this.showDialog(p_408953_, this, p_409779_);
            }

            @Override
            public void sendCustomAction(ResourceLocation p_409439_, Optional<Tag> p_409693_) {
                ClientConfigurationPacketListenerImpl.this.send(new ServerboundCustomClickActionPacket(p_409439_, p_409693_));
            }
