...
public class EditBox extends AbstractWidget {
    ...
    public void onClick(double p_279417_, double p_279437_) {
        int i = Mth.floor(p_279417_) - this.textX;
    ...
    public void renderWidget(GuiGraphics p_283252_, int p_281594_, int p_282100_, float p_283101_) {
        if (this.isVisible()) {
            ...
            if (!s.isEmpty() && flag && i < s.length()) {
                p_283252_.drawString(this.font, this.formatter.apply(s.substring(i), this.cursorPos), j, this.textY, i1, this.textShadow);
            }
            ...
            if (flag1) {
                if (flag2) {
                    p_283252_.fill(j1, this.textY - 1, j1 + 1, this.textY + 1 + 9, -3092272);
                } else {
