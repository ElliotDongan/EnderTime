...
public class GameNarrator {
    ...
    private void narrateMessage(String p_391325_, boolean p_392353_) {
        this.narrator.say(p_391325_, p_392353_, this.minecraft.options.getSoundSourceVolume(SoundSource.VOICE) * this.minecraft.options.getSoundSourceVolume(SoundSource.MASTER));
    }
