...
public class BrushableBlockRenderer implements BlockEntityRenderer<BrushableBlockEntity> {
    ...
    public void render(
        BrushableBlockEntity p_277712_, float p_277981_, PoseStack p_277490_, MultiBufferSource p_278015_, int p_277463_, int p_277346_, Vec3 p_395939_
    ) {
            ...
            if (i > 0) {
                ...
                if (direction != null) {
                    ...
                    if (!itemstack.isEmpty()) {
                        ...
                        p_277490_.mulPose(Axis.YP.rotationDegrees((flag ? 90 : 0) + 11));
                        p_277490_.scale(0.5F, 0.5F, 0.5F);
                        int j = LevelRenderer.getLightColor(
                            LevelRenderer.BrightnessGetter.DEFAULT, p_277712_.getLevel(), p_277712_.getBlockState(), p_277712_.getBlockPos().relative(direction)
                        );
                        this.itemRenderer
