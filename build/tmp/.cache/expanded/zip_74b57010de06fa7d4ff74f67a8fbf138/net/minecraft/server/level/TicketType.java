...
public record TicketType(long timeout, boolean persist, TicketType.TicketUse use) {
    ...
    private static TicketType register(String p_395985_, long p_395702_, boolean p_397904_, TicketType.TicketUse p_397946_) {
        return Registry.register(BuiltInRegistries.TICKET_TYPE, p_395985_, new TicketType(p_395702_, p_397904_, p_397946_));
    }
