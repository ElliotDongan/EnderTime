...
public class VersionCommand {
    ...
    public static void dumpVersion(Consumer<Component> p_406346_) {
        ...
        p_406346_.accept(Component.translatable("commands.version.pack.resource", worldversion.packVersion(PackType.CLIENT_RESOURCES)));
        p_406346_.accept(Component.translatable("commands.version.pack.data", worldversion.packVersion(PackType.SERVER_DATA)));
